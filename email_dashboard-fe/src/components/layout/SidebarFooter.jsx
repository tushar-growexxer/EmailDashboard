        ...
        <Tooltip content="Logout" side="right" delay={200} disabled={isSidebarOpen}>
          <button
            ...
            className={cn(
              ...
              isSidebarOpen
                ? "w-full px-3 sm:px-4 py-2 sm:py-3 gap-2 sm:gap-3 justify-start"
          ...
          >
            ...
            <span
              className={cn(
                "text-xs sm:text-sm font-medium transition-opacity duration-200 whitespace-nowrap overflow-hidden",
